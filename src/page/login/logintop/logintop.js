...
class LoginTop extends Component{
    constructor(props){
        super(props)
        this.state={
            back:{background:"rgb(238, 238, 238)",color:"#000"},
            islong:false
        }
